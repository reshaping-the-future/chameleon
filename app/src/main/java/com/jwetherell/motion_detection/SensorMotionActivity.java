 ...
 */
public abstract class SensorMotionActivity extends AppCompatActivity implements SensorEventListener {

	private static final String TAG = "SensorMotionActivity";
	...
	private static boolean mIsInMotion = false;
	...
	protected boolean getIsInMotion() {
		return mIsInMotion;
	}

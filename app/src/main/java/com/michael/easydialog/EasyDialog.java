...
import ac.robinson.chameleonnotifier.view.CustomDialog;
...
public class EasyDialog
{
	...
	private void initDialog(final Context context)
	{
		...
		dialog = new CustomDialog(context, isFullScreen() ? android.R.style.Theme_Translucent_NoTitleBar_Fullscreen : android.R.style.Theme_Translucent_NoTitleBar);
